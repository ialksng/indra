...
import { Send, Loader2, ImagePlus, X, Camera, Database, HardDrive, ChevronDown, MonitorUp, Bot, MousePointerClick, ShieldAlert } from 'lucide-react';
      ...
      <div className="p-3 bg-slate-800 border-b border-slate-700 flex flex-wrap gap-3 justify-between items-center z-20">
        <div className="relative group flex-1 min-w-[150px] max-w-[200px]">
          <select 
            ...
            className="w-full appearance-none bg-slate-700 text-white px-3 py-2 pr-10 rounded-lg border border-slate-600 focus:outline-none focus:border-purple-500 cursor-pointer text-sm font-medium truncate"
          >
