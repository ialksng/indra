      ...
      if (window.self !== window.top) {
        ...
        const handleMessage = (event) => {
          if (event.data?.type === 'DOM_MAP_RESPONSE') {
            ...
            console.log("Map generated by host loader:", event.data.payload);
        ...
        setTimeout(() => { 
          window.removeEventListener('message', handleMessage);
          console.warn("DOM Map Request Timed Out (Ensure loader.js is listening).");
          resolve([]);
        }, 3000);
      } else {
        ...
        console.log("Map generated natively:", map);
        resolve(map);
      }
    });
  };
